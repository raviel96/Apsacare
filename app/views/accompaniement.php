    ...
    <div class="main-container text-center">
        <div>
            <nav>
                <ul class="accomp-nav">
                    ...
                    <li><a href="#appui-psychologique">Appui psychologique</a></li>
                </ul>
            </nav>
        </div>
        <section id="individu">
                    ...
                    <ul>
                        ...
                        <li>
                            <p>d’un parcours d’accompagnement d’insertion professionnelle et sociale, initié par la DEETS Guadeloupe, en collaboration avec la Mission Locale et le Rectorat.
                                Nous avons appelé ce parcours « PAIPS 16/18».
                                Pour y accéder, rapprochez-vous de la Mission Locale de votre localité.
                                Il est ouvert pour les 16-18 ans.</p>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <section id="appui-social">
            ...
            <div class="expandable-card">
                ...
                <div class="card-content">
                    <p>Tout individu a des défis à relever et notre défi à nous, est de pouvoir identifier la problématique sociale qui peut venir freiner l’éclosion du projet professionnel. <br>
                        Une fois le frein identifié, nous dressons au bénéficiaire une prescription assortie de conseils et de coordonnées ciblées.
                        Et le service d’assistance sociale l’accompagne dans ses démarches.</p>
                </div>
            </div>
        </section>
            ...
            <div class="expandable-card">
                ...
                <div class="card-content">
                    <p>Le service « Emploi Formation » d’APSA CARE aide le bénéficiaire à faire émerger son projet professionnel,
                        ...
                        Nous mettons le bénéficiaire en relation avec les différents partenaires organismes de formation
                        et/ou entreprises afin de se projeter au plus près de la réalité de la fonction choisie.</p>
                    <p>Ainsi, il est mis en place des séjours de découverte en entreprise, des visites en centres de formation,
                        des enquêtes auprès des personnes occupant le poste sélectionné.
                        Nous travaillons les techniques de recherche d’emploi et aidons le bénéficiaire à rédiger son CV et sa lettre de motivation. </p>
                </div>
            </div>
        </section>
        <section id="appui-psychologique">
            ...
            <div class="expandable-card">
                ...
                <div class="card-content">
                    <p>Les psychologues qui travaillent en partenariat avec notre association, établissent un profil psychologique du bénéficiaire et mesurent le degré de l’estime qu’il a de lui-même. Ces deux paramètres sont importants car ils permettent à l’individu de repérer ce qui a pu empêcher son inclusion dans la société et dans l’entreprise de manière pérenne et accomplie. </p>
                </div>
            </div>
        </section>
        <p>Ces trois dispositifs sont complémentaires et interagissent en faveur de l’épanouissement de l’individu dans les différentes sphères dans lesquelles il évolue !</p>
    </div>
</main>